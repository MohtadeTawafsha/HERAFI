...
class CertificateRepositoryImpl implements CertificateRepository {
  ...
  @override
  Future<Either<Failure, void>> insertCertificate(CertificateEntity certificate) async {
    try {
      await remoteDataSource.insertCertificate(certificate);
  ...
  @override
  Future<Either<Failure, List<CertificateEntity>>> fetchCertificates(String craftsmanId) async {
    try {
