...
class selectPointOnMapScreenController extends GetxController{
  ...
  selectPointOnMapScreenController({required this.selectedMarker,required this.getSuggestionsUseCase});
  void confirm(){
